 ...
 *    flashing DSH's default typography. When `perTheme` is on, the row carries
 *    the dark theme's rules prefixed with the dark-theme attribute, so the
 *    first paint of each theme already uses that theme's own values.
 *
 * @module dsh-fonttune
 */
