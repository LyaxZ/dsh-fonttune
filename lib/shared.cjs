...
/**
 * Every durable axis field, live and retired: what normalization covers.
 */
 ...
 */
var INTERFACE_EXCLUDES = excludeAll(
  CODE_SURFACE_SELECTORS.concat([
    ".cm-editor",
    ".cm-editor *",
    ".dfp-previewCode",
    ".dfp-previewCode *",
...
function buildAxisCss(axis, baseTokens, isDark) {
  ...
  function pushScopedCodeFamily() {
    var scopedCode = [];
    var surfaces = splitSelectorList(CODE_SELECTOR);
